...
# sparsity = 0.3
# mask = rng.rand(num_neu_res, num_neu_res) > sparsity
# W_res = W_res[mask]
...
W_bias = rng.uniform(-1, 1, (num_neu_bias, num_neu_res + num_neu_out)) * in_scale * 0
...
system_parameters = {
    ...
    "test_file": "../tools/speech-to-spikes/gen_spike/w_32_5/test.bin",    # Replace with the actual test file path
    # "test_file": "../tools/speech-to-spikes/gen_spike/all_32_5/test.bin",    # Replace with the actual test file path
    # "test_file": "../tools/speech-to-spikes/gen_spike/all_16_10_10ms/test.bin",
    # "training_file": "../tools/speech-to-spikes/gen_spike/train",   # Replace with the actual training file path
    "training_file": "../tools/speech-to-spikes/gen_spike/w_32_5/train",   # Replace with the actual training file path
    # "training_file": "../tools/speech-to-spikes/gen_spike/all_32_5/train",   # Replace with the actual training file path
    # "training_file": "../tools/speech-to-spikes/gen_spike/all_16_10_10ms/train",

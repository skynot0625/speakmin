...
# num_pos_rows = num_neu_res - num_neg_rows
# 음수 행 (-1 ~ 0)
# W_out[:num_neg_rows] = rng.uniform(-1, 0, (num_neg_rows, num_neu_out))
# 양수 행 (0 ~ 1)
...
def generate_quantized_tau_samples(num_samples=512, lower_bound=0.0, upper_bound=6.0):
    ...
    # 초기 샘플 생성
    samples = rng.lognormal(mean=mu, sigma=sigma, size=num_samples)
    ...
    while len(tau_samples_resampled) < num_samples:
        additional_samples = rng.lognormal(mean=mu, sigma=sigma, 
    ...
    # tau_array_hetero = np.sort(tau_array_hetero)
...
system_parameters = {
    ...
    # "test_file": "../tools/speech-to-spikes/gen_spike/0615_all_64_2_4ms_stft_simplereduction/test",
    ...
    # "training_file": "../tools/speech-to-spikes/gen_spike/0615_all_64_2_4ms_stft_simplereduction/train",
    # "training_file": "../tools/speech-to-spikes/gen_spike/0623_all_64_2_10ms_stft_simplereduction_30_pre_norm_pre/train",
    # "training_file": "../tools/speech-to-spikes/gen_spike/0615_all_64_2_10ms_stft_simplereduction/train",
    # "training_file": "../tools/speech-to-spikes/gen_spike/0618_all_64_1_10ms_stft_simplereduction/train",
    # "training_file": "../tools/speech-to-spikes/gen_spike/0713_all_128_1_10ms_stft_simplereduction_pre_norm_pre/train", 
